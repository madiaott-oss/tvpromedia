...
export function formatChannelWithTvProLive(ch: Channel): Channel {
  ...
  const primaryLien = ch.lien && ch.lien.startsWith('https://www.tvpromedia.com') ? ch.lien.replace('https://www.tvpromedia.com', 'https://www.tvpromedia.com') : (originalSource || ipLien);
  return {
    ...ch,
